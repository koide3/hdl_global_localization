#ifndef AURRIGO_GLOBAL_LOCALIZATION_MATCHING_COST_EVALUATER_VOXELS_HPP
#define AURRIGO_GLOBAL_LOCALIZATION_MATCHING_COST_EVALUATER_VOXELS_HPP
...
#include <aurrigo_global_localization/ransac/voxelset.hpp>
