...
#include <aurrigo_global_localization/engines/global_localization_bbs.hpp>
#include <aurrigo_global_localization/engines/global_localization_fpfh_ransac.hpp>
#include <aurrigo_global_localization/engines/global_localization_fpfh_teaser.hpp>
...
int main(int argc, char** argv) {
  ros::init(argc, argv, "aurrigo_global_localization");
  ROS_INFO_STREAM("Start Global Localization Node");
  aurrigo_global_localization::GlobalLocalizationNode node;
  ros::spin();
