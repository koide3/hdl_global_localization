...
#include <aurrigo_global_localization/SetGlobalLocalizationEngine.h>
#include <aurrigo_global_localization/SetGlobalMap.h>
#include <aurrigo_global_localization/QueryGlobalLocalization.h>

class GlobalLocalizationTestNode {
public:
  GlobalLocalizationTestNode() : nh() {
    set_engine_service = nh.serviceClient<aurrigo_global_localization::SetGlobalLocalizationEngine>("/aurrigo_global_localization/set_engine");
    set_global_map_service = nh.serviceClient<aurrigo_global_localization::SetGlobalMap>("/aurrigo_global_localization/set_global_map");
    query_service = nh.serviceClient<aurrigo_global_localization::QueryGlobalLocalization>("/aurrigo_global_localization/query");
  ...
  void set_engine(const std::string& engine_name) {
    aurrigo_global_localization::SetGlobalLocalizationEngine srv;
  ...
  void set_global_map(pcl::PointCloud<pcl::PointXYZ>::Ptr cloud) {
    aurrigo_global_localization::SetGlobalMap srv;
  ...
  void points_callback(sensor_msgs::PointCloud2ConstPtr cloud_msg) {
    ...
    aurrigo_global_localization::QueryGlobalLocalization srv;
...
int main(int argc, char** argv) {
  ros::init(argc, argv, "aurrigo_global_localization_test");
